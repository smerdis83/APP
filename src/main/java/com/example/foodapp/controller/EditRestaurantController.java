...
public class EditRestaurantController {
    ...
    private void populateFields(String jsonResponse) {
        try {
            ...
            String workingHours = extractJsonValue(jsonResponse, "working_hours");
            if (workingHours != null) workingHoursField.setText(workingHours);
    ...
    private void saveChanges() {
        ...
        String taxFeeText = taxFeeField.getText();
        String additionalFeeText = additionalFeeField.getText();
        ...
        updateData.put("name", name.trim());
        updateData.put("address", address.trim());
        updateData.put("phone", phone.trim());

        // Add tax fee if provided
        if (taxFeeText != null && !taxFeeText.trim().isEmpty()) {
            try {
                int taxFee = Integer.parseInt(taxFeeText.trim());
        ...
        if (additionalFeeText != null && !additionalFeeText.trim().isEmpty()) {
            try {
                int additionalFee = Integer.parseInt(additionalFeeText.trim());
        ...
        updateData.put("description", description == null ? "" : description.trim());
        updateData.put("working_hours", workingHours == null ? "" : workingHours.trim());
